...
module braid_math::q64_tests {
    ...
    #[test]
    #[expected_failure(abort_code = q64::EOverflow)]
    ...
    #[test]
    #[expected_failure(abort_code = q64::EUnderflow)]
    ...
    #[test]
    #[expected_failure(abort_code = full_math::EDivideByZero)]
    ...
    #[test]
    #[expected_failure(abort_code = q64::EDivideByZero)]
